...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action='/store-register'>
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" placeholder="Nom complet" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="jc" placeholder="CIN" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="tel" placeholder="Numero de telephone" required>
                    </div>
                    <div class="form-group">
                ...
                <p class="mt-3 mb-0">Vous avez déjà un compte ? <a href='/login'>Se connecter</a></p>
            </div>
        </div>
    </div>
